...
var myEE = new stream_1.EventEmitter();
myEE.on('foo', function () { return console.log('My "foo" event received.'); });
...
var listener2 = function () { return console.log('I am listening for "foo" event too.'); };
myEE.on('foo', listener2);
setTimeout(function () { return myEE.removeListener("foo", listener2); }, 5000);
var gen = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _i, _a, n;
    return __generator(this, function (_b) {
        for (_i = 0, _a = eventGenerator(); _i < _a.length; _i++) {
            n = _a[_i];
            myEE.emit('foo_' + n);
        }
        return [2 /*return*/];
