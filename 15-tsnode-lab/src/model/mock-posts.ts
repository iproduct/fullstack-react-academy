...
const MOCK_POSTS = [
    ...
    {
        "title": "Learning React",
        "content": "**Functional Web Development** with *React* and *Redux*, 1st Edition",
    ...
    {
        "title": "New in Spring",
        "content": "Spring is Java framework ...",
